...
namespace InvoiceRegister.Migrations
{
    ...
    [Migration("20250203081522_ChangeInvoicesColumns")]
    partial class ChangeInvoicesColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvoiceRegister.Entities.InvoiceEntity", b =>
                {
                    ...
                    b.HasIndex("IssuerNip");

                    b.HasIndex("PaymentTypeId");

                    b.HasIndex("PurchaseNip");
            ...
            modelBuilder.Entity("InvoiceRegister.Entities.PaymentTypeEnumEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InvoiceRegister.Entities.InvoiceEntity", b =>
                {
                    ...
                    b.HasOne("InvoiceRegister.Entities.SubjectEntity", "Issuer")
                        .WithMany()
                        .HasForeignKey("IssuerNip")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("InvoiceRegister.Entities.PaymentTypeEnumEntity", "PaymentType")
                        .WithMany()
